...
(* OASIS_START *)
(* DO NOT EDIT (digest: 89c9cbddb9a7ae85ce41f1179f525177) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("core",
                               Some (OASISVersion.VGreaterEqual "109.35.00"));
                           FindlibPackage ("threads", None);
                           FindlibPackage ("ezxmlm", None)
                        ];
                   ...
                   {
                      lib_modules = ["Code_frag"; "Para_frag"; "Xml_tree"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "rwo";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                     cs_name = "rwo-run-toplevel";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "rwo_run_toplevel.ml";
                      });
               Executable
                 ({
                     cs_name = "rwo-syntax-highlight";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "rwo"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "rwo_syntax_highlight.ml";
                      });
               Executable
                 ({
                     cs_name = "rwo-html-code-highlight";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "rwo_html_code_highlight.ml";
                      })
            ];
          plugins =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "я(Ѕ\153HNZ**'Эиии#к";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
