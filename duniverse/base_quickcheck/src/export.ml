...
let quickcheck_generator_array = Generator.array
let quickcheck_generator_ref = Generator.ref
let quickcheck_generator_lazy_t = Generator.lazy_t
...
let quickcheck_observer_array = Observer.array
let quickcheck_observer_ref = Observer.ref
let quickcheck_observer_lazy_t = Observer.lazy_t
...
let quickcheck_shrinker_array = Shrinker.array
let quickcheck_shrinker_ref = Shrinker.ref
let quickcheck_shrinker_lazy_t = Shrinker.lazy_t
