...
module Span = struct
  include (Int63 : (module type of struct include Int63 end
  ...
  let to_time_span t ~calibrator =
    Time.Span.of_ns (Int63.to_float (to_ns t ~calibrator))
  ;;
end
...
let to_nanos_since_epoch t ~calibrator =
