...
let%test_module _ =
  (module struct
    ...
    let%test_module "Interval.V1.Float" = (module Stable_unit_test.Make(struct
        ...
        let tests = make_tests_v1 V1.Private.to_float
                      ~non_empty:
                        [ (1.5, 120.), "(1.5 120)",
    ...
    let%test_module "Interval.V1.Int" = (module Stable_unit_test.Make(struct
        ...
        let tests = make_tests_v1 V1.Private.to_int
      ...
      (module struct
        module Arg = struct
          ...
          let tests =
            ...
            in
            make_tests_v1 V1.Private.to_time
              ~non_empty: [ (t1, t2),
    ...
    let%test_module "Interval.V1.Ofday" = (module Stable_unit_test.Make(struct
        ...
        let tests =
          ...
          make_tests_v1 V1.Private.to_ofday
            ~non_empty:
...
let%test_module "vs array" =
  (module struct
    ...
    let%expect_test "explicit binary_search" =
      ...
      pr @@ binary_search (create 4 80) ~compare:Int.compare
              `First_strictly_greater_than 18;
      [%expect {| (19) |}];
      pr @@ binary_search (create 25 80) ~compare:Int.compare
              `First_strictly_greater_than 18;
      [%expect {| (25) |}];
      pr @@ binary_search (create 25 80) ~compare:Int.compare
