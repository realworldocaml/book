...
and copy_pattern_desc :
  Ast_412.Parsetree.pattern_desc -> Ast_411.Parsetree.pattern_desc =
  function
...
and copy_core_type :
  Ast_412.Parsetree.core_type -> Ast_411.Parsetree.core_type =
  fun
...
and copy_row_field :
  Ast_412.Parsetree.row_field -> Ast_411.Parsetree.row_field =
  fun
...
and copy_attribute :
  Ast_412.Parsetree.attribute -> Ast_411.Parsetree.attribute =
  fun
...
and copy_structure :
  Ast_412.Parsetree.structure -> Ast_411.Parsetree.structure =
...
and copy_with_constraint :
  ...
  | Ast_412.Parsetree.Pwith_modsubst (x0, x1) ->
      Ast_411.Parsetree.Pwith_modsubst
        ((copy_loc copy_Longident_t x0), (copy_loc copy_Longident_t x1))
and copy_signature :
  Ast_412.Parsetree.signature -> Ast_411.Parsetree.signature =
...
and copy_extension :
  Ast_412.Parsetree.extension -> Ast_411.Parsetree.extension =
  fun x ->
    let (x0, x1) = x in ((copy_loc (fun x -> x) x0), (copy_payload x1))
and copy_class_infos :
  'f0 'g0 .
    ('f0 -> 'g0) ->
      'f0 Ast_412.Parsetree.class_infos -> 'g0 Ast_411.Parsetree.class_infos
  =
  fun f0 ->
    fun
...
and copy_virtual_flag :
  Ast_412.Asttypes.virtual_flag -> Ast_411.Asttypes.virtual_flag =
  function
...
and copy_open_infos :
  'f0 'g0 .
    ('f0 -> 'g0) ->
      'f0 Ast_412.Parsetree.open_infos -> 'g0 Ast_411.Parsetree.open_infos
  =
  fun f0 ->
    fun
...
and copy_override_flag :
  Ast_412.Asttypes.override_flag -> Ast_411.Asttypes.override_flag =
  function
...
and copy_type_kind :
  Ast_412.Parsetree.type_kind -> Ast_411.Parsetree.type_kind =
  function
...
and copy_mutable_flag :
  Ast_412.Asttypes.mutable_flag -> Ast_411.Asttypes.mutable_flag =
  function
...
and copy_closed_flag :
  Ast_412.Asttypes.closed_flag -> Ast_411.Asttypes.closed_flag =
  function
  | Ast_412.Asttypes.Closed -> Ast_411.Asttypes.Closed
  | Ast_412.Asttypes.Open -> Ast_411.Asttypes.Open
and copy_label : Ast_412.Asttypes.label -> Ast_411.Asttypes.label =
  fun x -> x
