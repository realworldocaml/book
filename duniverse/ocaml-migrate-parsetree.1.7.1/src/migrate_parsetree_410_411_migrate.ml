...
and copy_expression_desc :
  ...
  | Ast_410.Parsetree.Pexp_sequence (x0, x1) ->
      Ast_411.Parsetree.Pexp_sequence
        ((copy_expression x0), (copy_expression x1))
  | Ast_410.Parsetree.Pexp_while (x0, x1) ->
      Ast_411.Parsetree.Pexp_while
        ((copy_expression x0), (copy_expression x1))
  ...
  | Ast_410.Parsetree.Pexp_constraint (x0, x1) ->
      Ast_411.Parsetree.Pexp_constraint
...
and copy_pattern_desc :
  Ast_410.Parsetree.pattern_desc -> Ast_411.Parsetree.pattern_desc =
  function
  ...
  | Ast_410.Parsetree.Ppat_interval (x0, x1) ->
      Ast_411.Parsetree.Ppat_interval
  ...
  | Ast_410.Parsetree.Ppat_variant (x0, x1) ->
      Ast_411.Parsetree.Ppat_variant
  ...
  | Ast_410.Parsetree.Ppat_constraint (x0, x1) ->
      Ast_411.Parsetree.Ppat_constraint
...
and copy_core_type :
  Ast_410.Parsetree.core_type -> Ast_411.Parsetree.core_type =
  fun
...
and copy_row_field :
  Ast_410.Parsetree.row_field -> Ast_411.Parsetree.row_field =
  fun
...
and copy_attribute :
  Ast_410.Parsetree.attribute -> Ast_411.Parsetree.attribute =
  fun
...
and copy_payload : Ast_410.Parsetree.payload -> Ast_411.Parsetree.payload =
  ...
  | Ast_410.Parsetree.PPat (x0, x1) ->
      Ast_411.Parsetree.PPat
        ((copy_pattern x0), (Option.map copy_expression x1))
and copy_structure :
  Ast_410.Parsetree.structure -> Ast_411.Parsetree.structure =
...
and copy_structure_item_desc :
  ...
  | Ast_410.Parsetree.Pstr_extension (x0, x1) ->
      Ast_411.Parsetree.Pstr_extension
...
and copy_class_expr_desc :
  ...
  | Ast_410.Parsetree.Pcl_constraint (x0, x1) ->
      Ast_411.Parsetree.Pcl_constraint
...
and copy_class_structure :
  ...
  fun
    ...
    ->
    {
      ...
      Ast_411.Parsetree.pcstr_fields =
...
and copy_class_field_kind :
  ...
  | Ast_410.Parsetree.Cfk_concrete (x0, x1) ->
      Ast_411.Parsetree.Cfk_concrete
...
and copy_with_constraint :
  ...
  | Ast_410.Parsetree.Pwith_modsubst (x0, x1) ->
      Ast_411.Parsetree.Pwith_modsubst
        ((copy_loc copy_Longident_t x0), (copy_loc copy_Longident_t x1))
and copy_signature :
  Ast_410.Parsetree.signature -> Ast_411.Parsetree.signature =
...
and copy_signature_item_desc :
  ...
  | Ast_410.Parsetree.Psig_extension (x0, x1) ->
      Ast_411.Parsetree.Psig_extension
        ((copy_extension x0), (copy_attributes x1))
...
and copy_class_signature :
  ...
  fun
    ...
    ->
    {
      ...
      Ast_411.Parsetree.pcsig_fields =
...
and copy_extension :
  Ast_410.Parsetree.extension -> Ast_411.Parsetree.extension =
  fun x ->
    let (x0, x1) = x in ((copy_loc (fun x -> x) x0), (copy_payload x1))
and copy_class_infos :
  'f0 'g0 .
    ('f0 -> 'g0) ->
      'f0 Ast_410.Parsetree.class_infos -> 'g0 Ast_411.Parsetree.class_infos
  =
  fun f0 ->
    fun
...
and copy_virtual_flag :
  Ast_410.Asttypes.virtual_flag -> Ast_411.Asttypes.virtual_flag =
  function
...
and copy_open_infos :
  'f0 'g0 .
    ('f0 -> 'g0) ->
      'f0 Ast_410.Parsetree.open_infos -> 'g0 Ast_411.Parsetree.open_infos
  =
  fun f0 ->
    fun
...
and copy_override_flag :
  Ast_410.Asttypes.override_flag -> Ast_411.Asttypes.override_flag =
  function
...
and copy_mutable_flag :
  Ast_410.Asttypes.mutable_flag -> Ast_411.Asttypes.mutable_flag =
  function
...
and copy_closed_flag :
  Ast_410.Asttypes.closed_flag -> Ast_411.Asttypes.closed_flag =
  function
  | Ast_410.Asttypes.Closed -> Ast_411.Asttypes.Closed
  | Ast_410.Asttypes.Open -> Ast_411.Asttypes.Open
and copy_label : Ast_410.Asttypes.label -> Ast_411.Asttypes.label =
  fun x -> x
...
and copy_constant : Ast_410.Parsetree.constant -> Ast_411.Parsetree.constant
  ...
  | Ast_410.Parsetree.Pconst_string (x0, x1) ->
      Ast_411.Parsetree.Pconst_string (x0, Location.none, (Option.map (fun x -> x) x1))
  | Ast_410.Parsetree.Pconst_float (x0, x1) ->
      Ast_411.Parsetree.Pconst_float (x0, (Option.map (fun x -> x) x1))
and copy_Longident_t : Ast_410.Longident.t -> Ast_411.Longident.t =
  function
  | Ast_410.Longident.Lident x0 -> Ast_411.Longident.Lident x0
  | Ast_410.Longident.Ldot (x0, x1) ->
      Ast_411.Longident.Ldot ((copy_Longident_t x0), x1)
  | Ast_410.Longident.Lapply (x0, x1) ->
      Ast_411.Longident.Lapply ((copy_Longident_t x0), (copy_Longident_t x1))
and copy_loc :
  'f0 'g0 .
  ...
  fun f0 ->
    fun { Ast_410.Asttypes.txt = txt; Ast_410.Asttypes.loc = loc } ->
      {
        Ast_411.Asttypes.txt = (f0 txt);
        Ast_411.Asttypes.loc = (copy_location loc)
      }
and copy_location : Ast_410.Location.t -> Ast_411.Location.t =
  fun
    ...
    ->
    {
      Ast_411.Location.loc_start = (copy_position loc_start);
