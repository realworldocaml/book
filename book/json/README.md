...
```ocaml file=../../examples/code/json/yojson_basic.mli
type json = [
...
```ocaml file=../../examples/code/json/yojson_basic.mli,part=1
...
```ocaml file=../../examples/code/json/yojson_basic_simple.mli
...
```ocaml file=../../examples/code/json/read_json/read_json.ml
open Core
...
```sh dir=../../examples/code/json/read_json
```
...
```ocaml file=../../examples/code/json/parse_book/parse_book.ml
open Core
...
```sh dir=../../examples/code/json/parse_book
...
```ocaml file=../../examples/code/json/list_excerpt.mli
...
```ocaml file=../../examples/code/json/list_excerpt.mli,part=1
...
```ocaml file=../../examples/code/json/yojson_safe.mli
type json = [
  | `Assoc of (string * json) list
  | `Bool of bool
  | `Float of float
...
```ocaml file=../../examples/code/json/yojson_safe.mli,part=1
...
```ocaml file=../../examples/code/json/github_j_excerpt.mli
...
```sh dir=../../examples/code/json/github_org_info
...
```ocaml file=../../examples/code/json/github_org_info/github_org_info.ml
open Core
...
```sh dir=../../examples/code/json/github_org_info,non-deterministic=output
