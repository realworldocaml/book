...
``` file=examples/correct/github/book.json
{
...
```ocaml file=examples/correct/yojson_basic/yojson_basic.mli,part=0
type json = [
...
```ocaml file=examples/correct/yojson_basic/yojson_basic.mli,part=1
...
```ocaml file=examples/correct/yojson_basic_simple/yojson_basic_simple.mli
...
```ocaml file=examples/correct/read_json/read_json.ml
open Core
...
```scheme file=examples/correct/read_json/dune
(executable
  (name      read_json)
...
```ocaml file=examples/correct/parse_book/parse_book.ml
open Core
...
```scheme file=examples/correct/parse_book/dune
(executable
  (name      parse_book)
  (libraries core yojson))
```
...
```ocaml file=examples/correct/list_excerpt/list_excerpt.mli,part=0
...
```ocaml file=examples/correct/list_excerpt/list_excerpt.mli,part=1
...
```ocaml file=examples/correct/yojson_safe/yojson_safe.mli,part=0
type json = [
  | `Assoc of (string * json) list
  | `Bool of bool
  | `Float of float
...
```ocaml file=examples/correct/yojson_safe/yojson_safe.mli,part=1
...
``` file=examples/correct/github/github.atd
type scope = [
    User <json name="user">
...
```ocaml file=examples/correct/github/github_j_excerpt.mli
...
``` file=examples/correct/github_org_info/github_org.atd
type org = {
  login: string;
  id: int;
  url: string;
...
```ocaml file=examples/correct/github_org_info/github_org_info.ml
open Core
