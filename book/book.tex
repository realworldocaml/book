...
\usepackage{listings, pmboxdraw, lstautogobble, color}
...
\definecolor{bluekeywords}{rgb}{0.10, 0.10, 1}
\definecolor{greencomments}{rgb}{0, 0.5, 0}
\definecolor{redstrings}{rgb}{0.9, 0.10, 0.10}
...
\title{%
  Real World OCaml \\
  \large Version 2, PDF edition (WIP)}
\date{}
