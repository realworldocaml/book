...
```ocaml file=examples/correct/int_interval_nosexp.mli
type t
...
```scheme file=examples/correct/test_interval_nosexp/dune
(executable
...
```sh dir=examples/correct/test_interval_nosexp
...
```ocaml file=examples/correct/int_interval_manual_sexp.mli
open Core
...
```ocaml file=examples/correct/sexp_override.ml
type t =
  | Range of int * int
  | Empty
[@@deriving sexp]
