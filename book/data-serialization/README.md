...
```ocaml file=../../examples/code/sexpr/sexp.mli
module Sexp : sig
  type t =
  | Atom of string
  | List of t list
...
```ocaml file=../../examples/code/sexpr/test_interval/int_interval.ml
...
```ocaml file=../../examples/code/sexpr/test_interval/test_interval.ml
open Core
...
```ocaml file=../../examples/code/sexpr/int_interval_nosexp.mli
type t
...
```ocaml file=../../examples/code/sexpr/int_interval_manual_sexp.mli
open Core
...
```ocaml file=../../examples/code/sexpr/test_interval/int_interval.mli
...
```ocaml file=../../examples/code/sexpr/sexp_override.ml
type t =
  | Range of int * int
  | Empty
[@@deriving sexp]
