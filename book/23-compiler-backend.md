...
We mentioned in [Variants](06-variants.html#variants){data-type=xref} that
...
[Table2301](23-compiler-backend.html#Table2301){data-type=xref} shows the
...
[Table2302](23-compiler-backend.html#Table2302){data-type=xref}).[native-code
