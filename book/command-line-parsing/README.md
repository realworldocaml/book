...
```ocaml file=examples/md5/md5.ml,part=0
open Core
...
```ocaml file=examples/md5/md5.ml,part=1
let filename_param =
...
```ocaml file=examples/md5/md5.ml,part=2
let command =
  Command.basic
...
```ocaml file=examples/md5/md5.ml,part=3
let () =
...
```ocaml file=examples/md5_succinct/md5.ml
open Core
...
```ocaml file=examples/md5_multiarg/md5.ml
open Core
...
```ocaml file=examples/md5_let_syntax/md5.ml,part=1
let command =
  Command.basic
    ~summary:"Generate an MD5 hash of the input data"
    ~readme:(fun () -> "More detailed information")
...
```ocaml file=examples/md5_let_syntax2/md5.ml,part=1
let command =
  Command.basic
    ~summary:"Generate an MD5 hash of the input data"
    ~readme:(fun () -> "More detailed information")
...
```ocaml file=examples/md5_as_filename/md5.ml,part=1
let command =
  Command.basic
    ~summary:"Generate an MD5 hash of the input data"
    ~readme:(fun () -> "More detailed information")
...
```ocaml file=examples/md5_with_custom_arg/md5.ml
open Core
...
```sh dir=examples/md5_with_custom_arg
$ dune exec -- ./md5.exe md5.ml
...
```ocaml file=examples/md5_with_optional_file_broken/md5.ml,part=1
let command =
  Command.basic
    ~summary:"Generate an MD5 hash of the input data"
    ~readme:(fun () -> "More detailed information")
...
```sh dir=examples/md5_with_optional_file_broken
$ dune build md5.exe
...
...
```ocaml file=examples/md5_with_optional_file/md5.ml
open Core
...
```sh dir=examples/md5_with_optional_file
...
```ocaml file=examples/md5_with_default_file/md5.ml
open Core
...
```sh dir=examples/md5_with_default_file
$ cat md5.ml | dune exec -- ./md5.exe
...
```ocaml file=examples/md5_sequence/md5.ml
open Core
...
```sh dir=examples/md5_sequence,non-deterministic=output
...
```ocaml file=examples/md5_with_flags/md5.ml
open Core
...
```sh dir=examples/md5_with_flags
$ dune exec -- ./md5.exe -help
Generate an MD5 hash of the input data
...
```ocaml file=examples/cal_add_days/cal.ml
open Core
...
```ocaml file=examples/cal_add_sub_days/cal.ml
open Core
...
```sh dir=examples/cal_add_sub_days
$ dune exec -- ./cal.exe -help
Manipulate dates
...
```ocaml file=examples/cal_add_interactive/cal.ml
open Core
...
```ocaml file=examples/cal_add_interactive2/cal.ml,part=1
...
```sh dir=examples/cal_add_interactive2
...
```sh dir=examples/md5_with_flags,non-deterministic=output
