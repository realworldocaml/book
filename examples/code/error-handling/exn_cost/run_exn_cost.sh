  ...
  File "exn_cost.ml", line 10, characters 33-37:
  Warning 3: deprecated: Exit
  ...
  File "exn_cost.ml", line 15, characters 10-14:
  Warning 3: deprecated: Exit
  [2016-09] this element comes from the stdlib distributed with OCaml.
  Refering to the stdlib directly is discouraged by Base. You should either
  use the equivalent functionality offered by Base, or if you really want to
  refer to the stdlib, use Caml.Exit instead
  File "exn_cost.ml", line 16, characters 7-11:
  Warning 3: deprecated: Exit
  [2016-09] this element comes from the stdlib distributed with OCaml.
  Refering to the stdlib directly is discouraged by Base. You should either
  use the equivalent functionality offered by Base, or if you really want to
  refer to the stdlib, use Caml.Exit instead
  File "exn_cost.ml", line 21, characters 32-36:
  Warning 3: deprecated: Exit
  [2016-09] this element comes from the stdlib distributed with OCaml.
  Refering to the stdlib directly is discouraged by Base. You should either
  use the equivalent functionality offered by Base, or if you really want to
  refer to the stdlib, use Caml.Exit instead
  File "exn_cost.ml", line 22, characters 7-11:
  Warning 3: deprecated: Exit
  [2016-09] this element comes from the stdlib distributed with OCaml.
  Refering to the stdlib directly is discouraged by Base. You should either
  use the equivalent functionality offered by Base, or if you really want to
